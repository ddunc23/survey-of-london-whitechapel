...
class FeatureOverviewSerializer(GeoFeatureModelSerializer):
	search_str = serializers.CharField(source='get_search_str', read_only=True)
	class Meta:
		model = Feature
		fields = ('id', 'b_number', 'b_name', 'street', 'address', 'feature_type', 'count', 'search_str')
		geo_field = 'geom'
