...
class WhitechapelSignupForm(SignupForm):
	def __init__(self, *args, **kwargs):
		...
		self.fields['username'].help_text = 'By default, your contributions will appear under your username. You can change this once you\'ve made an account.'
...
WhitechapelUserProfileFormExtra = inlineformset_factory(User, UserProfile, can_delete=False, fields=['emails', 'display_name', 'bio'], help_texts={'display_name': 'Your contributions will be attributed to you by your user name. If you\'d like to change this, enter a display name here.', 'bio': 'If you\'d like to tell us a little bit about yourself you can do so here. This information will be visible to other users if they look at your contributions.', 'emails': 'When you submit content and it\'s been approved by the Survey of London editors, you\'ll be notified by email. If you\'d rather not recieve these emails, uncheck this box. Your email address isn\'t visible on the website, and we won\'t share your contact details with anyone.'})